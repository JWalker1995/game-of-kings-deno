  ...
  <Modal open={open} onClose={() => setOpen(false)}>
    ...
    <Modal.Content>
      <Grid stackable divided='vertically'>
        ...
        <Grid.Row columns={1}>
          <Grid.Column width={16} style={{ fontSize: 16 }}>
            Three of your pieces angled 120° can "launch" the center piece. This
            glider can capture anything.<br />
          ...
          <Grid.Column style={{ marginTop: 0 }}>
            <BoardSnapshotRenderer
              ...
              formation={{
                ...
                '-4,0,4': { playerIndex: 0, type: 'pawn' },
                '-5,1,4': { playerIndex: 0, type: 'pawn' },
                '4,0,-4': { playerIndex: 1, type: 'pawn' },
              }}
              selectedCell='-4,0,4'
            />
          </Grid.Column>
        ...
        <Grid.Row columns={1}>
          ...
          <Grid.Column style={{ marginTop: 0 }}>
            <Table definition celled fixed compact unstackable>
              <Table.Header>
                <Table.Row>
                  <Table.HeaderCell />
        ...
        <Grid.Row columns={2}>
          <Grid.Column width={16} style={{ fontSize: 16 }}>
            The game starts with only kings. Pawns may be placed (spawned) next
            to your king into empty spaces.<br />
